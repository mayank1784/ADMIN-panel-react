...
const ResetPassword: React.FC = () => {
	...
	const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			// Navigate to another route after clicking OK on the alert
										...
										<form onSubmit={handleSubmit}>
											...
											<div className="mb-4">
												...
												<span>
													...
													account. This link will
													expire in 24 hours. This
													link will be valid only
													once.
												</span>
											</div>
